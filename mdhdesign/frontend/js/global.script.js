...
$(document).ready(function () {
  ...
  $(".tab-item .fix-width .menu-tab").css({
    width: 100 / $(".tab-item .fix-width .menu-tab").length + "%",
  });
...
$(document).on("click", ".tab-item .menu-tab", function (e) {
  e.preventDefault();
  var tabContentId = $(this).attr("data-content");

  $(this).parents(".tab-item").find(".menu-tab").removeClass("active");
