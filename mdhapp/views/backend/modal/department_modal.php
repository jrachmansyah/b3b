<div id="departmentAdd" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title"><?= $this->lang->line('tambah') . ' ' . $this->lang->line('department'); ?></h2>
        </header>
                ...
                <div class="modal-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" name="nama_department" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
...
<?php foreach ($dph as $a) { ?>
    <div id="sliderEdit<?= $a->id; ?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title"><?= $this->lang->line('ubah'); ?> <?= $this->lang->line('department'); ?></h2>
            </header>
            <form action="" method="post" enctype="multipart/form-data">
                <div class="panel-body">
                    <div class="modal-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <label class="control-label"><?= $this->lang->line('department'); ?> <?= $this->lang->line('nama'); ?></label>
                                <input type="text" name="nama_department" value="<?= $a->nama_department; ?>" class="form-control">
