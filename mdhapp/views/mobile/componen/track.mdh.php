<script>
    if ($("#map_todo_mdh").length > 0) {
            ...
            markersData = {
                Marker: [
                    <?php if ($absen->long_masuk != null) {  ?> {
                            name: "Check In",
                            location_latitude: <?= $absen->latitude_masuk; ?>,
                            location_longitude: <?= $absen->long_masuk; ?>,
                            map_image_url: "<?= base_url(); ?><?= $absen->image_masuk; ?>",
                            map_marker: "<?= base_url(); ?>mdhdesign/map/5.png",
                            name_point: "<?= $me->nama_awal; ?> <?= $me->nama_akhir; ?>",
                        },
                    <?php } ?>
                ],
            };
        ...
        var mapOptions = {
            zoom: 15,
            <?php if ($absen->long_masuk != null) {  ?>
                center: new google.maps.LatLng(<?= $absen->latitude_masuk; ?>, <?= $absen->long_masuk; ?>),
            <?php } ?>
